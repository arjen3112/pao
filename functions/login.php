...
function getregistratie()
{
    ...
    <form method="post" action="?menuoptie=inloggen">
    	<table id="tableLogin">
    		...
    		<tr>
    			<td>Adres: </td>
    			<td><input name="adres" type="text" placeholder="Straatnaam"
			';
    		...
    		<tr>
    			<td>Huisnummer: </td>
    			<td><input name="huisnummer" type="text" placeholder="Huisnummer"
			';
    		...
    		<tr>
    			<td>Postcode: </td>
    			<td><input name="postcode" type="text" placeholder="1234 AB"
			';
    		...
    		<tr>
    			<td>Telefoon: </td>
    			<td><input name="telefoon" type="text" placeholder="0123-123456"
			';
